...
function redirect_by_answer(){
	...
	if ( present_path == "nanpure.html" ){
		...
		if (answer == "白うさぎ"){
			...
			create_popup(`『<img src="images/mi2TKWYM_FGuYfWz.png" style="width: 1em; height: 1em;"></src>進数と<img src="images/FTKTbcjU_dSd4ELT.png" style="width: 1em; height: 1em;"></img><img src="images/BBfmTKNrc45DYPcw.png" style="width: 1em; height: 1em;"></img>進数が数字を解読するヒントだよ。もっとヒントが欲しいなら、くろねこ好きって言ってよ』`)
